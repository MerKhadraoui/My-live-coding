...
let d1=1;
let e1=22;
  function checkEvenOdd(numbs)
  {
      return numbs %2==0? console.log(numbs+ " is Even"):console.log(numbs+ " is Odd");
...
// 3.33
//let float1 = 13.4;
//let realLint= Math.floor(13.4);
console.log(Math.floor(111.4));
//
